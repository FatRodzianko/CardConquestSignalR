...
namespace CardConquestSignalR.Shared
{
    public class Player
    {
        ...
        public Player(string playername, string connectionid, bool ready, string roomname, int availabletanks, int availableinf, int unavailabletanks, int unavailableinf, List<Card> hand, List<Card>discardpile, int totalwins)
        {
