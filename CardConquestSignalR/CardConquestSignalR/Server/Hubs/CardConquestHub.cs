...
namespace CardConquestSignalR.Server.Hubs
{
...
");
        ...
        public void JoinRoom(string roomName)
        {
            ...
            else
            {
                ...
                {
                    List<Player> roomPlayers = (List<Player>)roomToJoin.Players;
        ...
        public void CreatePlayer(string playername, string connectionid)
        {
            ...
            playerList.Add(new Player(playername, connectionid, false, "", 4, 6, 0, 0, newCards, emptyCards, 0));
        }
        ...
        public async Task ReadyUp()
        {
            ...
            Game playerGame = new Game(1, "", null, null, "");
        ...
        public Game InitializeGame(Rooms playerRoom, Player RequestingPlayer)
        {
            // Get info for the other player
            Player player2 = playerRoom.Players.First(x => x.PlayerName != RequestingPlayer.PlayerName);
            ...
            // Create the game
            Game playerGame = new Game(1, "Unit Selection", playerArmies, playerRoom, "");
        ...
        {
            Game playerGame = new Game(0, null, null, null, "");
            playerGame = JsonConvert.DeserializeAnonymousType(playerGameToJson, playerGame);

            Player RequestingPlayer = playerGame.Room.Players.First(x => x.ConnectionId == Context.ConnectionId);
        ...
        public Game WinnerOfBattle(Game playerGame)
        {
        ...
        public Game ResolveAttackDefense(Game playerGame)
        {
            ...
            {
                Player WinningPlayer = playerGame.Room.Players.First(x => x.PlayerName == playerGame.WinningPlayer);
                Player LosingPlayer = playerGame.Room.Players.First(x => x.PlayerName != playerGame.WinningPlayer);
